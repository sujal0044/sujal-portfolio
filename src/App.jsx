...
export default function App() {
  ...
  // DIRECT DOM REF FOR 144Hz (Bypassing React State)
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      ...
      // Detect hover over text or links for the magnifying lens effect
      const target = e.target;
      const isHovering = target.closest('.text-magnify') || target.closest('a') || target.closest('button');
      
      if (isHovering) {
        cursorRef.current.classList.add('w-20', 'h-20', '-ml-10', '-mt-10');
        cursorRef.current.classList.remove('w-4', 'h-4', '-ml-2', '-mt-2');
      } else {
        cursorRef.current.classList.add('w-4', 'h-4', '-ml-2', '-mt-2');
        cursorRef.current.classList.remove('w-20', 'h-20', '-ml-10', '-mt-10');
      }
    };
  ...
  return (
    <div className={`bg-[#050505] text-white min-h-screen font-sans overflow-x-hidden selection:bg-[#ff6a00] selection:text-white relative ${isDesktop ? 'cursor-none' : ''}`}>
      ...
      {/* 144Hz TRUE LENS CURSOR */}
      {isDesktop && (
        <div 
          ref={cursorRef}
          className="fixed top-0 left-0 w-4 h-4 -ml-2 -mt-2 bg-white rounded-full pointer-events-none z-[9999] mix-blend-difference transition-[width,height,margin] duration-300 ease-out will-change-transform"
        />
      )}
      ...
      {!loading && (
        <>
          ...
          <nav className="fixed top-0 left-0 w-full p-6 md:p-10 flex justify-between items-center z-50 pointer-events-none">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="font-bold text-xl tracking-tighter pointer-events-auto text-magnify inline-block transition-all duration-300 hover:scale-110 hover:drop-shadow-[0_0_10px_rgba(255,106,0,0.8)] cursor-none">
          ...
          <section className="relative min-h-screen flex items-center justify-center pt-20 px-6 overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-5xl mt-10">
               <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="text-[#ff6a00] uppercase tracking-widest text-sm font-bold mb-8 text-magnify inline-block transition-all duration-300 hover:scale-105 hover:text-white hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">
                 Creative Technologist • AI Enthusiast
               </motion.div>
               <br />
               <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter mb-8 leading-none text-magnify inline-block transition-all duration-300 hover:scale-[1.03] hover:drop-shadow-[0_0_20px_rgba(255,106,0,0.3)]">
                 BUILDING <br /> THE <span className="text-[#ff6a00]">FUTURE.</span>
               </motion.h1>
               <br />
               <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7, duration: 1 }} className="text-gray-300 text-lg md:text-2xl max-w-3xl mx-auto font-light leading-relaxed text-magnify inline-block transition-all duration-300 hover:scale-[1.02] hover:text-white">
          ...
          <div className="max-w-7xl mx-auto px-6 space-y-32 pb-40 relative z-10">
              ...
              <TiltCard>
                <div className="bg-[#0a0a0a] border border-[#222] p-12 md:p-24 rounded-3xl relative overflow-hidden transition-colors hover:border-[#ff6a00]/30 shadow-2xl">
                  <div className="relative z-20">
                    <h2 className="text-4xl md:text-6xl font-black mb-10 tracking-tight text-magnify inline-block transition-all duration-300 hover:scale-105 hover:drop-shadow-[0_0_15px_rgba(255,106,0,0.5)]">The <span className="text-[#ff6a00]">Mindset.</span></h2>
                    <div className="grid md:grid-cols-2 gap-12 text-gray-300 text-lg leading-relaxed font-light">
                      <p className="text-magnify inline-block transition-all duration-300 hover:scale-[1.02] hover:text-white hover:drop-shadow-md">The architecture of code means nothing without the architecture of the mind. My journey from India to the heart of London's tech landscape wasn't just geographical; it was an evolution of extreme discipline. I operate at the intersection of rigorous logic and relentless creativity.</p>
                      <p className="text-magnify inline-block transition-all duration-300 hover:scale-[1.02] hover:text-white hover:drop-shadow-md">I study human psychology and stoicism as intensely as I study machine learning algorithms. The ability to remain exceptionally calm under immense pressure is the ultimate developer superpower. When servers crash or complex models fail, I don't panic. <strong className="text-white font-bold">I execute.</strong></p>
                    </div>
                  </div>
                </div>
              </TiltCard>
            ...
            {/* TECHNICAL ARSENAL */}
            <section>
               <h2 className="text-3xl font-bold mb-12 flex items-center gap-4 text-magnify inline-flex transition-all duration-300 hover:scale-105 hover:text-white"><Code className="text-[#ff6a00]" /> Technical Arsenal</h2>
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                 {[
                   ...
                   <TiltCard key={i} className="h-full">
                     <div className="bg-[#0a0a0a] border border-[#222] p-10 rounded-2xl h-full hover:border-[#ff6a00]/50 transition-colors cursor-none text-magnify inline-block hover:scale-[1.03] duration-300 hover:drop-shadow-xl w-full">
            ...
            {/* SELECTED WORKS */}
            <section>
              <h2 className="text-3xl font-bold mb-12 flex items-center gap-4 text-magnify inline-flex transition-all duration-300 hover:scale-105 hover:text-white"><Layers className="text-[#ff6a00]" /> Selected Works</h2>
                ...
                {[
                  ...
                  <TiltCard key={i}>
                    <div className="bg-[#0a0a0a] border border-[#222] p-10 rounded-3xl h-full hover:border-[#ff6a00]/40 transition-all cursor-none group">
                      <div className="flex justify-between items-start mb-6 text-magnify inline-flex w-full transition-all duration-300 hover:scale-105">
                      ...
                      <p className="text-gray-400 mb-6 font-light text-magnify inline-block transition-all duration-300 hover:scale-[1.02] hover:text-white">{project.desc}</p>
                      <br/>
            ...
            {/* EXPERIENCE */}
            <section>
              <h2 className="text-3xl font-bold mb-12 flex items-center gap-4 text-magnify inline-flex transition-all duration-300 hover:scale-105 hover:text-white"><Terminal className="text-[#ff6a00]" /> Operational Experience</h2>
              <div className="space-y-6">
                {[
                  ...
                  { role: "Freelance Creative Developer", company: "Independent", year: "2023 - 2024", desc: "Architected modern web experiences, integrating headless CMS and secure Firebase authentication." }
                   ...
                   <div key={i} className="bg-[#0a0a0a] border border-[#222] p-8 rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center group cursor-none hover:border-[#ff6a00]/30 transition-all text-magnify hover:scale-[1.01] hover:drop-shadow-lg duration-300">
            ...
            <section className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
               {[
                 ...
                 <TiltCard key={i}>
                   <div className="bg-[#0a0a0a] border border-[#222] p-8 rounded-2xl cursor-none hover:bg-[#111] transition-all text-magnify hover:scale-105 hover:drop-shadow-xl duration-300">
            ...
            <section className="text-center pt-20">
               <TiltCard>
                 <div className="bg-[#0a0a0a] border border-[#222] p-16 md:p-32 rounded-[4rem] relative overflow-hidden cursor-none hover:border-[#ff6a00]/40 transition-all duration-300 shadow-2xl">
                   ...
                   <h2 className="text-5xl md:text-8xl font-black tracking-tighter mb-6 relative z-10 text-white text-magnify inline-block transition-all duration-300 hover:scale-105 hover:drop-shadow-[0_0_20px_rgba(255,255,255,0.4)]">
               ...
               <div className="flex justify-center gap-10 mt-20 text-gray-400 relative z-10 text-magnify inline-flex transition-all duration-300 hover:scale-110">
